...
<div class="bg-[#171825] p-8  h-screen ">
    <div class="bg-[#1D1E2C] h-full rounded-3xl overflow-y-auto">
        <section class="py-8 px-20">
            ...
            <h2 class="mb-3" style="text-align: center;">Tambah Data Mahasiswa</h2>

            <form action="tambah.php" method="post" enctype="multipart/form-data" class="py-4 flex flex-col gap-8">
                ...
                <div class="flex flex-col gap-4">
                        ...
                        <select name="jurusan" id="jurusan" class="col-sm-10">
                                <?php 
                                    $opt = ['Teknik Informatika', 'Teknik Industri', 'Teknik Mesin', 'Teknik Kimia', 'Arsitek'];
                                    $output = '';
                ...
                <button style="background-color: #24263A; padding: 8px 20px; border-radious: 8px; width: max-content;" type="submit">Create</button>
            </form>
