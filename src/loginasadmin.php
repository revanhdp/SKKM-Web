...
<body>
    <div class="sky h-screen flex justify-end">
        <form action="cek_loginadmin.php" method="POST" autocomplete="off" class="bg-white rounded-l-3xl gap-8 flex flex-col items-center justify-center" style="width: 60%;">
            <h1 class="text-3xl font-bold text-[#24263A]">Login as Admin to e-SKKM</h1>
            <div class="space-y-8">
                <div class="flex flex-col gap-1">
                    <label for="username" class="w-max font-bold text-[#24263A]">USERNAME</label>
                    <input required type="text" name="username" id="username" placeholder="ex: admin" class="text-[#24263A] border-2 border-zinc-400 focus:border-[#24263A] px-2 w-[512px] focus:scale-x-105 transition-all py-2 rounded">
                </div>
                <div class="flex flex-col gap-1">
            ...
            <p class="text-zinc-400">Anda adalah mahasiswa? <a href="index.php" class="text-[#24263A]">login sebagai Mahasiswa</a></p>
        </form>
        <?php
